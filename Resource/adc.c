...
/// P0.3/ADC8 0正常 1低压 2高压
uint4 get_03ADC(uint4 last_index)
{
  uint16 three = getADCNumByNum(3);// 210~240V
  if(three < 250-AREA)
  {
    return 1;
  }
...
// P0.5/ADC2/IGBT1温度10K 5V   0正常1表示开路  2.3温高  2表示超温  65C
uint4 get_11ADC()
{
  uint16  IGBTTemp = getADCNumByNum(5);
...
//P2.6/ADC4/线盘温度 10K 5V   0正常 1表示超温 2表示开路   120
uint4 get_07ADC()
{
  uint16  StringTemp = getADCNumByNum(26);
...
/* P0.4/ADC5/锅底温度 10K 5V   0x13*/
uint4 get_06ADC()
{
  uint16  PotTemp = getADCNumByNum(4);
  if(PotTemp >NULL_NUM)
  {
    return 2;
  }
